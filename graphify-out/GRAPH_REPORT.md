# Graph Report - Logic_simulator_web-app  (2026-06-28)

## Corpus Check
- 19 files · ~34,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 359 nodes · 821 edges · 22 communities (17 shown, 5 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 240 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad16f236`
...
- `buildPalette()` --calls--> `builtinDefs()`  [INFERRED]
  js/ui.js → js/model.js
...
Cohesion: 0.10
Nodes (57): busValue(), inputVals(), matrixLit(), addrWidth(), compSize(), isGate(), numInputsOf(), numOutputsOf() (+49 more)

### Community 2 - "Interaction & Navigation"
Cohesion: 0.12
Nodes (41): buildMenuLevel(), compMenuItems(), copySelection(), enterComponent(), goToLevel(), hideContextMenu(), initInteractions(), initSplit() (+33 more)

### Community 3 - "Edit Operations & Wiring"
Cohesion: 0.09
Nodes (46): afterStructChange(), exprTreeForOutputPin(), addAt(), dedupeLabel(), deleteSelection(), dragWireSegment(), onCanvasDrop(), onUIHit() (+38 more)

### Community 4 - "Simulation Engine"
Cohesion: 0.11
Nodes (37): afterSimChange(), applyTTRow(), bitEq(), busConflict(), clockTick(), computeTruthTable(), copyVal(), ctxForViewStack() (+29 more)

### Community 5 - "Boolean Expressions & Timeline"
Cohesion: 0.11
Nodes (35): defineBuiltin(), registerBuiltinDefs(), timelineSignals(), topOutputExprs(), createDefFromCircuit(), customDefs(), registerDef(), serializeCircuit() (+27 more)
...
Cohesion: 0.25
Nodes (7): Architecture, Custom agent types available, File ownership, Key invariants, Logic Lab — Project Guide, Patterns for new features, Run tests
...
## Knowledge Gaps
- **71 isolated node(s):** `node`, `name`, `version`, `type`, `main` (+66 more)
